...
const OrderInfo = forwardRef<OrderInfoHandle, OrderInfoProps>(
  ({ initialId, isSales, onDeleteSuccess }, ref) => {
    ...
    console.log("asdasfafasdsad", service);
    return (
      <>
        {isLoading ? (
          ...
          <div className="main-info w-full p-5">
            {service?.rejection_reason ? (
              <div
                className="h-24	overflow-hidden rounded-md"
                style={{ backgroundColor: "#FCEAEA" }}
              >
                <PiWarningOctagonFill className="text-red-500 m-2.5 text-2xl	" />

                <div>
                  <p className="font-semibold text-sm	m-2.5">Rejection Reason</p>
                  <p style={{ color: "#34485F" }} className=" text-sm	m-2.5">
                    {service?.rejection_reason}
                  </p>
                </div>
              </div>
            ...
            <div className="border rounded px-2 my-4 flex justify-between overflow-hidden">
              <div className="flex">
                ...
                <div
                  ...
                  className={`${
                    ...
                    service?.status == "accepted"
                      ...
                      : "bg-white"
                  } p-1  flex items-center border rounded-2xl`}
                >
                  {isSales && (
                    <FontAwesomeIcon
                      className="mx-1"
          ...
          <div>
            <div className="main-container flex justify-center h-72 items-center flex-col">
