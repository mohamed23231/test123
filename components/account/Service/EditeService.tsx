...
interface AccountServiceProp {
  ...
  EditeServiceDataHandler: (data: AccountServiceSchemaInterface) => void;
  service: any;
}

const EditeService = ({
  EditeServiceDataHandler,
  register,
  handleSubmit,
  isLoading,
  errors,
    ...
    <>
      <div className="mt-20 flex justify-center items-center">
        <form
          ...
          onSubmit={handleSubmit(EditeServiceDataHandler)}
        >
